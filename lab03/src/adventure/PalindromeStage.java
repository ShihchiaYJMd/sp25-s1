...
public class PalindromeStage implements AdventureStage {
    ...
    private static IntList reverseList(IntList l) {
        ...
        while (l != null) {     // lab03: iterate through list
    ...
    private static IntList digitsToIntList(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {  // lab03: iterate through string#
            a[i] = Character.getNumericValue(s.charAt(i));  // lab03: convert char to int
        }
        return IntList.of(a);
    }
